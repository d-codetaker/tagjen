...
<style>
    .background-blue {
    background: linear-gradient(45deg, #6E54F3, #5DB3E6);
}

.background-yellow {
    background: linear-gradient(45deg, #EF2064, #FFA500);
}

.background-green {
    background: linear-gradient(45deg, #3DAE56, #47E1AD);
}

.background-red {
    background: linear-gradient(45deg, #A558A6, #EC3970);
}
